...
Hub 上 `checkpoints/b0/` 是 32 步 `--try`（gate 0.301），**不是** 8B 包络。发布信封进行中的 overlay 在 [`b0-full/`](b0-full/README.md)（Hub 钉 B200 step 26760，≈1.61% of 8e9；micro-batch=2）。约每 10 分钟覆盖同路径。
