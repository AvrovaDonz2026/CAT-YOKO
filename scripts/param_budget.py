...
TIERS: dict[str, Tier] = {
    ...
    "low": Tier("cheaper-compute band", "low", ns_e=1, tk_e=4, nr_e=20, ns_d=1, tk_d=6, nr_d=20),
    "middle": Tier("default (middle band)", "middle", ns_e=1, tk_e=7, nr_e=20, ns_d=1, tk_d=10, nr_d=20),
    "near_dense": Tier("near-dense band", "near_dense", ns_e=1, tk_e=12, nr_e=20, ns_d=1, tk_d=16, nr_d=20),
}
