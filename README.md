...
- [`docs/B200_TRAIN.md`](docs/B200_TRAIN.md) — B200 / SM100 算子与开训（Hub overlay step 25460；micro-batch=2）
...
# B200 / SM100（Hub overlay step 25460 续训，硬件 NVFP4；默认 micro-batch=2）：
