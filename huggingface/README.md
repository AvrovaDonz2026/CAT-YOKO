...
| `checkpoints/b0-full/trainable.pt` | 6000D 发布档 B0 进行中（8e9 信封，seq=4096） | step **10680**；`tokens_in_phase=43,616,256`（≈0.55%）；sha256 `26c6c84193482fc273fb330b3d49c4af1f49579bc8b11ba6b64317749529ae07`。torch nightly + grouped MoE / fused QKV / chunked CE。~2820 tok/s。同阶段 resume 可接。不是终局。 |
