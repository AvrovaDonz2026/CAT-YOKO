...
| `checkpoints/b0-full/trainable.pt` | Vast B200 发布档 B0 进行中（8e9 信封，seq=4096） | Hub 钉 step **21500**；`tokens_in_phase=87,934,976`（≈1.10%）；sha256 `756e986489d30b27cd7c12280ec7c207a4008d28549f84f8f243f663a90165fc`。132 张量、无 Adam。torch 2.11+cu128 + TE nvcc 12.9 SM100。该快照是 micro-batch=1（~12.4k tok/s，HBM 96GiB）。线上已改 **micro-batch=2**（~15.7k tok/s，HBM ~138GiB），尚未把更新 overlay 推上 Hub。MiniCPM5 上采样后 overlay 本文件，同阶段 resume。不是终局。 |
