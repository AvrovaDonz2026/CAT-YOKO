...
**本机即将释放。** 权重在 Hub [`checkpoints/b0-full/`](https://huggingface.co/AvrovaDonz/CAT-YOKO/tree/main/checkpoints/b0-full)；日志在本目录。下一台按 [`checkpoints/b0-full/README.md`](../../../checkpoints/b0-full/README.md) 接训。
