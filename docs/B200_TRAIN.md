...
上一台 6000D 停在 step **16020**。B200 已续到 step **24060**，`tokens_in_phase=106,448,896`（8e9 的 ≈1.33%）。权重在 https://huggingface.co/AvrovaDonz/CAT-YOKO/tree/main/checkpoints/b0-full 。
