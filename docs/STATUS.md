...
| RTX 3090 sm_86 | BF16 `bf16-probe` A→E + 算子账本（旧实例 plan-probe 已回收） | **142 claims ok**；Flash GQA + cuDNN mask；日志 [`artifacts/autodl-rtx3090/bf16-verify/`](../artifacts/autodl-rtx3090/bf16-verify/README.md)。旧 plan-probe：[`plan-verify/`](../artifacts/autodl-rtx3090/plan-verify/README.md) |
