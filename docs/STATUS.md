...
| RTX 3090 sm_86 | BF16 `bf16-probe` A→E + 算子 roofline；B0 BF16 续训写 **独立目录** | **142 claims ok**；Flash **85%** / MoE bmm **81%** of 71.16T；滑窗 fat tiles 256。Hub `b0-full` step **26940** / sha256 `7eebc9a4…` **不动**；续训 SAVE=`b0-3090-bf16`。日志 [`bf16-verify/`](../artifacts/autodl-rtx3090/bf16-verify/README.md)、[`mfu/`](../artifacts/autodl-rtx3090/bf16-verify/mfu/README.md)。旧 plan-probe 128 claims：[`plan-verify/`](../artifacts/autodl-rtx3090/plan-verify/README.md) |
