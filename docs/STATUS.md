...
| RTX 3090 sm_86 | INT8 mini-verify（SageBwd QK / Triton） | B0→F bf16+int8_probe 各 2 步 ok；12B dummy B0 1 步 `int8_backend=triton`；日志 [`artifacts/autodl-rtx3090/`](../artifacts/autodl-rtx3090/README.md) |
